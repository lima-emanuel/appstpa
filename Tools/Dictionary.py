...
def init_default_elements_dictionary():
    ...
    elements[Constant.SEC_SPOOFING] = [Constant.SEC_SPOOFING]
    elements[Constant.SEC_TAMPERING] = [Constant.SEC_TAMPERING]
    elements[Constant.SEC_REPUDIATION] = [Constant.SEC_REPUDIATION]
    elements[Constant.SEC_INFORMATION_DISCLOSURE] = [Constant.SEC_INFORMATION_DISCLOSURE]
    elements[Constant.SEC_DENIAL_OF_SERVICE] = [Constant.SEC_DENIAL_OF_SERVICE]
    elements[Constant.SEC_ELEVATION_OF_PRIVILEGE] = [Constant.SEC_ELEVATION_OF_PRIVILEGE]

    elements[Constant.SEC_SPOOFING_CONTROL] = [Constant.SEC_SPOOFING_CONTROL]
    elements[Constant.SEC_TAMPERING_CONTROL] = [Constant.SEC_TAMPERING_CONTROL]
    elements[Constant.SEC_REPUDIATION_CONTROL] = [Constant.SEC_REPUDIATION_CONTROL]
    elements[Constant.SEC_INFORMATION_DISCLOSURE_CONTROL] = [Constant.SEC_INFORMATION_DISCLOSURE_CONTROL]
    elements[Constant.SEC_DENIAL_OF_SERVICE_CONTROL] = [Constant.SEC_DENIAL_OF_SERVICE_CONTROL]
    elements[Constant.SEC_ELEVATION_OF_PRIVILEGE_CONTROL] = [Constant.SEC_ELEVATION_OF_PRIVILEGE_CONTROL]
